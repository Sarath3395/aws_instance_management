...
def main(start_stops):
    ...
    ec2_con_re=get_ec2_con_for_given_region(my_region,"sdf","asdf")
...
def start(request):
    start_stop="start"
    #instance_id = request.GET["startid"]
    #print("+++++++++++"+instance_id)
    main("start")
...
def regioninstances(request):
    if request.method == 'POST':
        ...
        return render(request, 'instances.html',{'list':list})
    else:
